# Per-position importance scores for gapped kmer SVMs using Integrated Gradients
...
The code that implements the gkmexplain interpretation method is at https://github.com/kundajelab/lsgkm (see gkmexplain.c under "src").
